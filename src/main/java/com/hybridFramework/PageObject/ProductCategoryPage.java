...
public class ProductCategoryPage {
	...
	public void selectItemAndAddToCart(int item) throws Exception
	{
		WebElement element = driver.findElements(By.xpath("//*[@id='center_column']/ul/li/div/div[1]/div/a[1]/img")).get(item-1);
		Actions act=new Actions(driver);
		act.moveToElement(element).build().perform();
		
		Thread.sleep(3000);
		WebElement cart = driver.findElements(By.xpath("//*[@id='center_column']/ul/li/div/div[2]/div[2]/a[1]/span")).get(item-1);
		cart.click();
