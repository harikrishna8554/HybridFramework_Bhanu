...
public class TestBase {
	...
	static {
		...
		extent = new ExtentReports(System.getProperty("user.dir") + "\\src\\main\\java\\com\\hybridFramework\\report\\test_" + formater.format(calendar.getTime()) + ".html", false);
	}
	
	@BeforeMethod
	public void launchBrowser(Method result) throws Exception{
